...
public class ImageResource {
    ...
    public byte[] photo(@PathVariable String id) throws IOException {
    ...
    final TokenWrapper tokenWrapper, @RequestParam(value = "image", required = false) MultipartFile image) {
        imageController.uploadImageAssociation(tokenWrapper, image);
    }

    /*
     * @RequestMapping(value = Uris.ANIMALS, method = RequestMethod.POST, headers = "content-type=multipart/*") public void
     * uploadImage(@Valid final AnimalWrapper animalWrapper, @RequestParam(value = "image", required = false) MultipartFile[] images) {
